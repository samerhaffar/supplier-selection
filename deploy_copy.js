...
const bytecodePath = path.join(__dirname, 'SmartContractBytecode.bin');
const bytecode = fs.readFileSync(bytecodePath, 'utf8');

// Create a new contract object using the ABI and bytecode
const abi = require('./SmartContractAbi.json');
...
async function deploy() {
    ...
    try {
        ...
        const deployedAddressPath = path.join(__dirname, 'SmartContractAddress.bin');
